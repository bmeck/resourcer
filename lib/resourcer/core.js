...
resourcer.define = function (name, definition) {
    ...
    // Setup inheritance
    //
    // Remark (indexzero): This causes sibling resources to have side effects
    // on each others prototypes. Not sure the best solution here, but the assignment
    // to __proto__ should be an isolated copy of the resource.Resource constructor 
    // and prototype
    //
